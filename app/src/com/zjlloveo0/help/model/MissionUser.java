...
public class MissionUser extends Mission implements Parcelable {
    ...
    public static final Parcelable.Creator<MissionUser> CREATOR = new Creator<MissionUser>() {
        ...
        public MissionUser createFromParcel(Parcel source) {
            ...
            missionUser.setCreateTime(new Date(source.readString()));
            String finishTime = source.readString();
            missionUser.setFinishTime(finishTime == null || "null".equals(finishTime) || "".equals(finishTime) ? null : new Date(source.readString()));
            ...
            missionUser.setUpdateTime(new Date(source.readString()));
            return missionUser;
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(getFinishTime() + "");
