...
/**
 * Created by zjlloveo0 on 2017/5/8.
 */
...
public class CustomRefreshListView extends ListView implements AbsListView.OnScrollListener {
     ...
     * 头部刷新失败的图片
     */
    private ImageView refresh_fail;

    /**
     * 头部刷新成功的图片
     */
    private ImageView refresh_succ;
    ...
    private void initHeaderView() {
        ...
        refresh_fail = (ImageView) headerView.findViewById(R.id.refresh_fail);
        refresh_succ = (ImageView) headerView.findViewById(R.id.refresh_succ);
        //测量headView的高度
