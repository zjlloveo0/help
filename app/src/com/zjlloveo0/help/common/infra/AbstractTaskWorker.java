...
public abstract class AbstractTaskWorker {
    ...
    private final Executor getExecutor(Task task) {
        ...
        return com.zjlloveo0.help.common.infra.TaskExecutor.IMMEDIATE_EXECUTOR;
    }

    private final Runnable getRunnable(final com.zjlloveo0.help.common.infra.Task task) {
        return new Runnable() {
            @Override
            public void run() {
                // schedule
